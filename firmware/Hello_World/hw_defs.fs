...
\ memory map uart:
h# 6900 constant uart_data 
h# 6902 constant uart_avail
h# 6904 constant uart_error
h# 6906 constant uart_busy


\ memory map espectro:
h# 7200 constant espectro_enable   
h# 7202 constant espectro_frh  
h# 7204 constant espectro_frl
h# 7206 constant espectro_init
